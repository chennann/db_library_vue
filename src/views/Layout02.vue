...
import { readerInfoService } from '@/api/reader.js';
...
const getUserInfo = async () => {
    ...
    let result = await readerInfoService();
...
<template>
        ...
        <el-aside width="200px">
            ...
            <el-menu active-text-color="#ffd04b" background-color="#041c32" text-color="#fff" unique-opened="true" router>
                <el-menu-item index="/reader_book">
                    <el-icon>
                        <Management />
                    </el-icon>
                    <span>图书</span>
                ...
                <el-sub-menu index="2">
                    ...
                    <el-menu-item index="/reader_borrows">
                        <el-icon>
                            <User />
                        </el-icon>
                        <span>借阅记录</span>
                    </el-menu-item>
                    <el-menu-item index="/reader_reservation">
                        <el-icon>
                            <Service />
                        </el-icon>
                        <span>预约记录</span>
                    </el-menu-item>
                    <el-menu-item index="/reader_info">
                        <el-icon>
                            <Service />
                        </el-icon>
                        <span>个人信息</span>
        ...
        <el-container>
            <!-- 头部区域 -->
            <el-header>
                <div>读者：<strong>{{ userInfoStore.info.readerId ? userInfoStore.info.readerId : '' }}</strong></div>
